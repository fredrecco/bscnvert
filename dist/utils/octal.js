...
const BaseConvertError_1 = __importDefault(require("../errors/BaseConvertError"));
exports.default = {
    /**
    ...
    toChar: (value) => {
        try {
            if (typeof (value) !== "string")
                throw new BaseConvertError_1.default(`The provided value must be a string, but received ${typeof (value)}.`);
            return value
                .split(" ")
    ...
    toDecimal: (value) => {
        try {
            if (typeof (value) !== "string" && typeof (value) !== "number")
                throw new BaseConvertError_1.default(`The provided value must be a string or number, but received ${typeof (value)}.`);
